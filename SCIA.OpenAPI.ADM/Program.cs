...
namespace OpenAPIAndADMDemo
{
    class Program
    {
        ...
        /// <summary>
        /// Creates a structural model using the new ModelBuilder framework
        /// </summary>
        /// <param name="model">The SCIA Structure to build</param>
        // private static void CreateModelWithBuilders(Structure model)
        // {
        //     try
        //     {
        //         var director = new ModelDirector();
        //         var result = director.BuildCompleteModel(model);
                
        //         Console.WriteLine("Model created successfully using ModelBuilder framework!");
        //     }
        //     catch (Exception ex)
        //     {
        //         Console.WriteLine($"Error creating model with builders: {ex.Message}");
        //         throw;
        //     }
        // }
        ...
        /// <summary>
        /// Tests the improved builder pattern concept
        /// This demonstrates the architectural improvements we've made
        /// </summary>
